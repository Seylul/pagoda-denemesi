...
// $base sanity check.
if ( 'BASE' == $base )
	die( /*WP_I18N_BASE_ERROR*/'<code>wp-config.php</code> dosyasında ayar hatası. <code>$base</code> ayarı <code>BASE</code> olarak düzenlenmiş, halbuki <code>/</code> ya da <code>/bloglar/</code> benzeri bir yol olmalıydı.'/*/WP_I18N_BASE_ERROR*/ );
...
if ( !isset( $current_site ) || !isset( $current_blog ) ) {
	...
	if ( false !== strpos( $domain, ':' ) ) {
		if ( substr( $domain, -3 ) == ':80' ) {
			...
			wp_die( /*WP_I18N_NO_PORT_NUMBER*/'Çoklu site adreste port numarası olmadığında çalışır.'/*/WP_I18N_NO_PORT_NUMBER*/ );
		}
	}
	...
	if ( ! $blog_id ) {
		if ( defined( 'WP_INSTALLING' ) ) {
			...
			$msg = ! $wpdb->get_var( "SHOW TABLES LIKE '$wpdb->site'" ) ? ' ' . /*WP_I18N_TABLES_MISSING*/'Veritabanı tabloları eksik.'/*/WP_I18N_TABLES_MISSING*/ : '';
			wp_die( /*WP_I18N_NO_BLOG*/'Bu sistem üzerinde böyle bir isme sahip site yok.'/*/WP_I18N_NO_BLOG*/ . $msg );
		}
	}
}
