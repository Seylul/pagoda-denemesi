...
function wp_unregister_GLOBALS() {
	...
	if ( isset( $_REQUEST['GLOBALS'] ) )
		die( /*WP_I18N_GLOBALS_OVERWRITE*/'GLOBALS üzerine yazma denemesi bulundu'/*/WP_I18N_GLOBALS_OVERWRITE*/ );
...
function wp_check_php_mysql_versions() {
	...
	if ( version_compare( $required_php_version, $php_version, '>' ) )
		die( sprintf( /*WP_I18N_OLD_PHP*/'Sunucunuz PHP %1$s sürümü kullanıyor fakat WordPress %2$s en az %3$s gerektirir.'/*/WP_I18N_OLD_PHP*/, $php_version, $wp_version, $required_php_version ) );

	if ( !extension_loaded( 'mysql' ) && !file_exists( WP_CONTENT_DIR . '/db.php' ) )
		die( /*WP_I18N_OLD_MYSQL*/'PHP kurulumunuzda WordPress\'in çalışması için gerekli olan MySQL eklentisi eksik.'/*/WP_I18N_OLD_MYSQL*/ );
}
...
?>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title><?php echo /*WP_I18N_MAINTENANCE*/'Bakım'/*/WP_I18N_MAINTENANCE*/; ?></title>

	</head>
	<body>
		<h1><?php echo /*WP_I18N_MAINT_MSG*/'Zamanlanmış bakım dolayısıyla site uygun değil. Bir kaç dakika içinde tekrar kontrol edin.'/*/WP_I18N_MAINT_MSG*/; ?></h1>
	</body>
	</html>
<?php
	die();
...
function wp_set_wpdb_vars() {
	...
	if ( is_wp_error( $prefix ) )
		wp_die( /*WP_I18N_BAD_PREFIX*/'<strong>HATA</strong>: <code>wp-config.php</code> dosyasında belirtilen <code>$table_prefix</code> sadece rakam, harf ve altçizgi içerebilir.'/*/WP_I18N_BAD_PREFIX*/ );
}
